    ...
    return(
        <section className="h-[88%] w-full overflow-y-scroll  text-center  flex flex-col items-center">
            ...
            <section className="min-h-[525px] w-full px-6 flex flex-col items-center justify-evenly ">
                <figure className="flex flex-row items-center justify-center  gap-3 text-white text-xl">
                   <div className="h-12 w-12 rounded-full border-gray-400 border grid place-items-center  hover:border-white transition duration-300 " onClick={cambios} >1</div>
